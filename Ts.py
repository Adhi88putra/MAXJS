...
#ANTIJS_V2
#cl = LineClient()
cl = LineClient(authToken='EyaWZvGI6KxeQeuMlhk8.h0dLm9gzqKE1Oaznh1hgAa.XMlS029RSXT4Selz5HVPTwv+cMPnOr75zbYnhG0SMiY=')
cl.log("Auth Token : " + str(cl.authToken))
channel = LineChannel(cl)
cl.log("Channel Access Token : " + str(channel.channelAccessToken))

#ki = LineClient()
ki = LineClient(authToken='EyeqtGFvoUtPZCP3NuB9.nuUU5kRRG+fC3Z9YVNv7Qq.m1Z8quAsMOxEmAwlHoA4qiT2oKJ7v2fS4f5msuJpdfY=')
ki.log("Auth Token : " + str(ki.authToken))
channel1 = LineChannel(ki)
ki.log("Channel Access Token : " + str(channel1.channelAccessToken))

#kk = LineClient()
kk = LineClient(authToken='EyHBoJ29czH5jSg9diE2.buJLD7JrrngDnMf5qDfqyG.bXYTjd9K5ufsD9qDVjUpatmrtDf3VCsHWH8mW97o10Y=')
kk.log("Auth Token : " + str(kk.authToken))
channel2 = LineChannel(kk)
kk.log("Channel Access Token : " + str(channel2.channelAccessToken))

#kc = LineClient()
kc = LineClient(authToken='Eyyzcs5UoNa7p6J9BC7f.9eQsWmyR4F9AFNPZDyQTtW.VDc2a15oXpksvtj0sv60GncTGDv4r6x2eQHs+CFW1Sg=')
kc.log("Auth Token : " + str(kc.authToken))
channel3 = LineChannel(kc)
kc.log("Channel Access Token : " + str(channel3.channelAccessToken))

#sw = LineClient()
sw = LineClient(authToken='Eyh44jkWV1GvQK35mgH3.TrVjFf5pyd8D+ZxPusvq0W.UpSy0Jr37NlNV1nhfdCL5s5RqqB0nL6jwjG6+iRoDOU=')
